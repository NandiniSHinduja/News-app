...
public class Health extends AppCompatActivity {
    ...
    private void getNews() {
        ...
        String url = "https://gnews.io/api/v4/search?q=health&token=0c243233b83850b148196490dd2a3c0c";
                ...
                (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            Glide.with(Health.this).load(icon1).into(image1);
                            ...
                            Glide.with(Health.this).load(icon2).into(image2);
                            ...
                            Glide.with(Health.this).load(icon3).into(image3);
                            ...
                            Glide.with(Health.this).load(icon4).into(image4);
                            ...
                            Glide.with(Health.this).load(icon5).into(image5);
                            ...
                            Glide.with(Health.this).load(icon6).into(image6);
                            ...
                            Glide.with(Health.this).load(icon7).into(image7);
                            ...
                            Glide.with(Health.this).load(icon8).into(image8);
                            ...
                            Glide.with(Health.this).load(icon9).into(image9);
                            ...
                            Glide.with(Health.this).load(icon10).into(image10);
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Health.this, error.toString(), Toast.LENGTH_LONG).show();
