...
public class Sports extends AppCompatActivity {
    ...
    private void getNews() {
        ...
        String url = "https://gnews.io/api/v4/search?q=sports&token=0c243233b83850b148196490dd2a3c0c";
                ...
                (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            Glide.with(Sports.this).load(icon1).into(image1);
                            ...
                            Glide.with(Sports.this).load(icon2).into(image2);
                            ...
                            Glide.with(Sports.this).load(icon3).into(image3);
                            ...
                            Glide.with(Sports.this).load(icon4).into(image4);
                            ...
                            Glide.with(Sports.this).load(icon5).into(image5);
                            ...
                            Glide.with(Sports.this).load(icon6).into(image6);
                            ...
                            Glide.with(Sports.this).load(icon7).into(image7);
                            ...
                            Glide.with(Sports.this).load(icon8).into(image8);
                            ...
                            Glide.with(Sports.this).load(icon9).into(image9);
                            ...
                            Glide.with(Sports.this).load(icon10).into(image10);
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Sports.this, error.toString(), Toast.LENGTH_LONG).show();
